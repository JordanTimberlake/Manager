import { u as useCookie, s as script$2$2, a as script$5$2, b as script$6$2, R as Ripple, U as UniqueComponentId, g as getVNodeProp, _ as _default, Z as ZIndex, C as ConnectedOverlayScrollHandler, c as script$x, d as script$3$2, e as script$4$2 } from './index-BX0FDCFU.mjs';
import { B as BaseStyle, s as setAttribute, e as equals, f as contains, Q as getFirstFocusableElement, l as resolveFieldData, R as invokeElementMethod, g as getAttribute, S as getNextElementSibling, G as getOuterWidth, T as getPreviousElementSibling, O as isNotEmpty, L as getOuterHeight, z as focus, D as addStyle, U as absolutePosition, V as isTouchDevice, F as FilterOperator, E as getIndex, i as isClickable, k as clearSelection, m as localeComparator, o as sort, q as FilterService, t as FilterMatchMode, v as findSingle, x as findIndexInList, y as find, A as exportCSV, C as getOffset, H as getHiddenElementOuterWidth, I as getHiddenElementOuterHeight, J as reorderArray, K as getWindowScrollTop, M as removeClass, N as addClass, P as isEmpty } from './server.mjs';
import { ref, mergeProps, withCtx, openBlock, createBlock, createVNode, useSSRContext, createElementBlock, toDisplayString, resolveDirective, withDirectives, resolveDynamicComponent, resolveComponent, normalizeClass, createSlots, Fragment, renderList, createTextVNode, normalizeProps, renderSlot, createCommentVNode, createElementVNode, withModifiers, Transition, withKeys } from 'vue';
import { s as script$5$3, a as script$2$3, b as script$b$1, c as script$1$6, d as script$y, e as script$6$3 } from './index-B04uZKwN.mjs';
import { S as Spinner, s as script$1$5, a as script$w } from './Spinner-BAsfqhRw.mjs';
...
var _hoisted_1$g = ["aria-label", "aria-current", "onClick", "data-p-active"];
...
var script$k = {
  ...
  components: {
    CheckIcon: script$1$5,
    MinusIcon: script$l
  }
};
var _hoisted_1$c = ["data-p-checked", "data-p-indeterminate", "data-p-disabled"];
var _hoisted_2$a = ["id", "value", "name", "checked", "tabindex", "disabled", "readonly", "required", "aria-labelledby", "aria-label", "aria-invalid", "aria-checked"];
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const generateHash = (data10, algorithm = "SHA256") => {
      return "https://gravatar.com/avatar/" + CryptoJS[algorithm](data10).toString(CryptoJS.enc.Hex);
    };
    const refresh = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Column = script$v;
      ...
      _push(`</div></div><div style="${ssrRenderStyle(!loading2.value ? null : { display: "none" })}" class="card mt-6">`);
      _push(ssrRenderComponent(_component_DataTable, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-wrap items-center justify-between gap-2"${_scopeId}><span class="text-xl font-bold"${_scopeId}>Employees</span>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Column, { header: "Image" }, {
              body: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img${ssrRenderAttr("src", generateHash(_ctx.email))} alt="gravatarImage" class="w-24 rounded"${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      src: generateHash(_ctx.email),
                      alt: "gravatarImage",
                      class: "w-24 rounded"
                    }, null, 8, ["src"])
                  ];
...
//# sourceMappingURL=employees-DYpCVJ9L.mjs.map
