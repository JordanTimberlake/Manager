...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const logout = async () => {
      try {
        const data2 = await $fetch("https://vitreous-bert-jordantimberlake-dd542edd.koyeb.app/api/auth/signout/", {
          method: "POST",
          headers: {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="profile"><div class="divider"></div><div class="profileContent">`);
      _push(ssrRenderComponent(unref(script$2), {
        image: "/images/media/default.png",
        shape: "circle",
        alt: "avatar"
      }, null, _parent));
      _push(`<p class="text-center md:text-sm md:contents hidden">${ssrInterpolate((_a = user.value) == null ? void 0 : _a.username)}</p></div></div></div>`);
...
//# sourceMappingURL=default-DuXyHsLa.mjs.map
